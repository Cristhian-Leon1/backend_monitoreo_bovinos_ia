...
from app.models.medicion_models import MedicionCreate, MedicionUpdate, MedicionResponse
from app.controllers.medicion_controller import medicion_controller
...
async def create_medicion(
    ...
    try:
        ...
        medicion = await medicion_controller.create_medicion(medicion_data, current_user_id)
...
async def get_mediciones_by_bovino(
    ...
    try:
        ...
        mediciones = await medicion_controller.get_mediciones_by_bovino(bovino_id, current_user_id)
...
async def get_medicion_by_id(
    ...
    try:
        ...
        medicion = await medicion_controller.get_medicion_by_id(medicion_id, current_user_id)
...
async def update_medicion(
    ...
    try:
        ...
        updated_medicion = await medicion_controller.update_medicion(medicion_id, medicion_data, current_user_id)
...
async def delete_medicion(
    ...
    try:
        ...
        deleted = await medicion_controller.delete_medicion(medicion_id, current_user_id)
...
async def get_mediciones_by_date_range(
    ...
    try:
        ...
        mediciones = await medicion_controller.get_mediciones_by_fecha_range(
...
async def get_ultima_medicion_bovino(
    ...
    try:
        ...
        medicion = await medicion_controller.get_ultima_medicion_bovino(bovino_id, current_user_id)
...
async def get_estadisticas_mediciones_bovino(
    ...
    try:
        ...
        estadisticas = await medicion_controller.get_estadisticas_mediciones_bovino(bovino_id, current_user_id)
