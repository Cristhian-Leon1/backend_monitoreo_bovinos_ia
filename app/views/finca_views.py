...
from app.models.finca_models import FincaCreate, FincaUpdate, FincaResponse, FincaWithBovinos, FincaWithBovinosAndMediciones
from app.controllers.finca_controller import finca_controller
...
async def create_finca(
    ...
    """
    try:
        finca = await finca_controller.create_finca(finca_data, current_user_id)
        return finca
...
async def get_my_fincas(current_user_id: str = Depends(get_current_user_id)):
    ...
    """
    try:
        fincas = await finca_controller.get_fincas_by_user(current_user_id)
        return fincas
...
async def get_finca_by_id(
    ...
    """
    try:
        finca = await finca_controller.get_finca_by_id(finca_id, current_user_id)
...
async def update_finca(
    ...
    """
    try:
        updated_finca = await finca_controller.update_finca(finca_id, finca_data, current_user_id)
...
async def delete_finca(
    ...
    """
    try:
        deleted = await finca_controller.delete_finca(finca_id, current_user_id)
...
async def get_finca_with_bovinos(
    ...
    """
    try:
        finca = await finca_controller.get_finca_with_bovinos(finca_id, current_user_id)
...
async def get_finca_complete(
    ...
    """
    try:
        finca_completa = await finca_controller.get_finca_with_bovinos_and_mediciones(finca_id, current_user_id)
