...
from app.models.bovino_models import BovinoCreate, BovinoUpdate, BovinoResponse, BovinoWithMediciones
from app.controllers.bovino_controller import bovino_controller
...
async def create_bovino(
    ...
    """
    try:
        bovino = await bovino_controller.create_bovino(bovino_data, current_user_id)
        return bovino
...
async def get_bovinos_by_finca(
    ...
    """
    try:
        bovinos = await bovino_controller.get_bovinos_by_finca(finca_id, current_user_id)
        return bovinos
...
async def get_bovino_by_id(
    ...
    """
    try:
        bovino = await bovino_controller.get_bovino_by_id(bovino_id, current_user_id)
...
async def update_bovino(
    ...
    """
    try:
        updated_bovino = await bovino_controller.update_bovino(bovino_id, bovino_data, current_user_id)
...
async def delete_bovino(
    ...
    """
    try:
        deleted = await bovino_controller.delete_bovino(bovino_id, current_user_id)
...
async def get_bovino_with_mediciones(
    ...
    """
    try:
        bovino = await bovino_controller.get_bovino_with_mediciones(bovino_id, current_user_id)
...
async def search_bovinos_by_id(
    ...
    """
    try:
        bovinos = await bovino_controller.search_bovinos_by_id(id_bovino, current_user_id)
        return bovinos
